...
def getOutput(status):
    ...
    con = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'root', database = 'voting',charset='utf8')
    with con:
        cur = con.cursor()
...
def AddPartyAction(request):
    if request.method == 'POST':
      ...
      db_connection = pymysql.connect(host='127.0.0.1',port = 3306,user = 'root', password = 'root', database = 'voting',charset='utf8')
